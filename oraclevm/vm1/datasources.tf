...
data "oci_core_vnic_attachments" "bigtappWebserver1_VNIC1_attach" {
...
data "oci_core_vnic" "bigtappWebserver1_VNIC1" {
  vnic_id = data.oci_core_vnic_attachments.bigtappWebserver1_VNIC1_attach.vnic_attachments.0.vnic_id
}
