...
COMPOSE_URL="https://raw.githubusercontent.com/j0904/deploy/main/bluesky/pds/compose.yml"
...
PDS_DID_PLC_ENABLED=true
PDS_DID=did:plc:pgesxcxxefyhnebpu36bqaijpqlds5pz
PDS_CONFIG
